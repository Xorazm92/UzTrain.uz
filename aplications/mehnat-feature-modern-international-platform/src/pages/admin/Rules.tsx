...
export default function Rules() {
  ...
  const onSubmit = async (formData: RuleFormData) => {
    try {
  ...
  return (
    <div className="space-y-6">
      <DataTable
        ...
        searchKey="titleblob"
        onAdd={handleAdd}
        addButtonText="Yangi Qoida Qo'shish"
        title="Qoidalar"
      />
      ...
      <FormDialog
        ...
        title={editingItem ? 'Qoida Tahrirlash' : 'Yangi Qoida Qo\'shish'}
        description="Qoida ma'lumotlarini kiriting"
      >
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            <Input
              ...
              placeholder="Qoida sarlavhasini kiriting"
            />
          </div>
          ...
          <div>
            ...
            <Textarea
              id="content"
              {...register('content')}
              placeholder="Qoida mazmunini kiriting"
              rows={4}
            />
          </div>
      ...
      <ConfirmDialog
        ...
        description={`"${deletingItem?.titleblob}" qoidasini o'chirishni tasdiqlaysizmi? Bu amalni bekor qilib bo'lmaydi.`}
